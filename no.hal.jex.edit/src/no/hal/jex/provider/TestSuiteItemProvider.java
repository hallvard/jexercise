...
public class TestSuiteItemProvider
	...
	/**
	 * This adds a property descriptor for the Test Runs feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTestRunsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TestSuite_testRuns_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TestSuite_testRuns_feature", "_UI_TestSuite_type"),
				 JexPackage.Literals.TEST_SUITE__TEST_RUNS,
				 true,
				 false,
				 true,
				 null,
