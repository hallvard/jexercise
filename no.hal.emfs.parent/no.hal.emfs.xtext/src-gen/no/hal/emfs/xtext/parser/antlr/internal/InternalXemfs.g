...
(
    ...
    { 
        $current = $this_XmlStringContents_2.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleXmlStringContents returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getXmlStringContentsRule()); }
	 iv_ruleXmlStringContents=ruleXmlStringContents 
	 { $current=$iv_ruleXmlStringContents.current; } 
	 EOF 
;

// Rule XmlStringContents
ruleXmlStringContents returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='<<' 
...
(
    ...
    { 
        $current = $this_XmlPIElement_0.current; 
        afterParserOrEnumRuleCall();
    }
...
entryRuleXmlPIElement returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getXmlPIElementRule()); }
	 iv_ruleXmlPIElement=ruleXmlPIElement 
	 { $current=$iv_ruleXmlPIElement.current; } 
	 EOF 
;

// Rule XmlPIElement
ruleXmlPIElement returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='?' 
...
entryRuleXmlTagName returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getXmlTagNameRule()); } 
	 iv_ruleXmlTagName=ruleXmlTagName 
	 { $current=$iv_ruleXmlTagName.current.getText(); }  
	 EOF 
;

// Rule XmlTagName
ruleXmlTagName returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(    this_ID_0=RULE_ID    {
...
entryRuleXmlInt returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getXmlIntRule()); } 
	 iv_ruleXmlInt=ruleXmlInt 
	 { $current=$iv_ruleXmlInt.current.getText(); }  
	 EOF 
;

// Rule XmlInt
ruleXmlInt returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
