 ...
 *   <li>{@link no.hal.emfs.impl.EmfsFileImpl#getVersions <em>Versions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EmfsFileImpl extends EmfsResourceImpl implements EmfsFile {
	...
	public EList<EmfsFileContentProvider> getVersions() {
		if (versions == null) {
			versions = new EObjectContainmentEList<EmfsFileContentProvider>(EmfsFileContentProvider.class, this, EmfsPackage.EMFS_FILE__VERSIONS);
		}
		return versions;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case EmfsPackage.EMFS_FILE__VERSIONS:
				getVersions().clear();
				getVersions().addAll((Collection<? extends EmfsFileContentProvider>)newValue);
				return;
		}
