...
/**
 * This is the item provider adapter for a {@link no.hal.emfs.GitRepoRef} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GitRepoRefItemProvider 
	 ...
	 * @generated
	 */
	public GitRepoRefItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GitRepoRef_host_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GitRepoRef_host_feature", "_UI_GitRepoRef_type"),
				 EmfsPackage.Literals.GIT_REPO_REF__HOST,
				 true,
				 false,
				 false,
	...
	protected void addOwnerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GitRepoRef_owner_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GitRepoRef_owner_feature", "_UI_GitRepoRef_type"),
				 EmfsPackage.Literals.GIT_REPO_REF__OWNER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRepoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GitRepoRef_repo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GitRepoRef_repo_feature", "_UI_GitRepoRef_type"),
				 EmfsPackage.Literals.GIT_REPO_REF__REPO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((GitRepoRef) object).getRemoteString();
		return label == null || label.length() == 0 ?
			getString("_UI_URLContentProvider_type") : label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(GitRepoRef.class)) {
