 ...
 * @generated
 */
public class ImportRuleItemProvider extends PathRuleItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ImportRuleItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ImportRule"));
	}
	...
	public String getText(Object object) {
		String label = ((ImportRule)object).getFullPath();
		return label == null || label.length() == 0 ?
			getString("_UI_ImportRule_type") :
			getString("_UI_ImportRule_type") + " " + label;
	}
