...
/**
 * Manual modifications go to {no.hal.jex.jextest.ui.JexTestUiModule}
 */
@SuppressWarnings("all")
public abstract class AbstractJexTestUiModule extends org.eclipse.xtext.xbase.ui.DefaultXbaseUiModule {
	
	public AbstractJexTestUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.HIGHLIGHTING)).to(no.hal.jex.jextest.parser.antlr.internal.InternalJexTestLexer.class);
	}
	...
	public Class<? extends org.eclipse.jface.viewers.ILabelProvider> bindILabelProvider() {
		return no.hal.jex.jextest.ui.labeling.JexTestLabelProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.labeling.LabelProviderFragment
	public void configureResourceUIServiceLabelProvider(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.jface.viewers.ILabelProvider.class).annotatedWith(org.eclipse.xtext.ui.resource.ResourceServiceDescriptionLabelProvider.class).to(no.hal.jex.jextest.ui.labeling.JexTestDescriptionLabelProvider.class);
	}

	// contributed by org.eclipse.xtext.ui.generator.outline.OutlineTreeProviderFragment
	public Class<? extends org.eclipse.xtext.ui.editor.outline.IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return no.hal.jex.jextest.ui.outline.JexTestOutlineTreeProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.quickfix.IssueResolutionProvider> bindIssueResolutionProvider() {
		return no.hal.jex.jextest.ui.quickfix.JexTestQuickfixProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.contentAssist.ContentAssistFragment
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return no.hal.jex.jextest.ui.contentassist.JexTestProposalProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return no.hal.jex.jextest.ui.contentassist.antlr.JexTestParser.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(no.hal.jex.jextest.ui.contentassist.antlr.internal.InternalJexTestLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(no.hal.jex.jextest.ui.contentassist.antlr.internal.InternalJexTestLexer.class));
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.CONTENT_ASSIST)).to(no.hal.jex.jextest.ui.contentassist.antlr.internal.InternalJexTestLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.ui.codetemplates.ui.partialEditing.IPartialContentAssistParser> bindIPartialContentAssistParser() {
		return no.hal.jex.jextest.ui.contentassist.antlr.PartialJexTestContentAssistParser.class;
	}
