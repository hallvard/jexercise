...
:
(
{ before(grammarAccess.getMethodAccess().getReturnTypeJvmTypeReferenceParserRuleCall_2_0()); }
	ruleJvmTypeReference{ after(grammarAccess.getMethodAccess().getReturnTypeJvmTypeReferenceParserRuleCall_2_0()); }
)
