...
public class JexTestParser extends AbstractContentAssistParser {
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getJexTestCaseAccess().getAlternatives_6(), "rule__JexTestCase__Alternatives_6");
					put(grammarAccess.getJexTestCaseAccess().getAlternatives_6_0_0(), "rule__JexTestCase__Alternatives_6_0_0");
					...
					put(grammarAccess.getJexTestCaseAccess().getGroup_2(), "rule__JexTestCase__Group_2__0");
					put(grammarAccess.getJexTestCaseAccess().getGroup_4(), "rule__JexTestCase__Group_4__0");
					put(grammarAccess.getJexTestCaseAccess().getGroup_6_0(), "rule__JexTestCase__Group_6_0__0");
					put(grammarAccess.getJexTestCaseAccess().getGroup_6_0_2(), "rule__JexTestCase__Group_6_0_2__0");
					...
					put(grammarAccess.getJexTestSequenceAccess().getGroup_4(), "rule__JexTestSequence__Group_4__0");
					put(grammarAccess.getJexTestSequenceAccess().getGroup_4_2(), "rule__JexTestSequence__Group_4_2__0");
					...
					put(grammarAccess.getJexTestCaseAccess().getTestedClassAssignment_1(), "rule__JexTestCase__TestedClassAssignment_1");
					put(grammarAccess.getJexTestCaseAccess().getTestClassNameAssignment_2_1(), "rule__JexTestCase__TestClassNameAssignment_2_1");
					put(grammarAccess.getJexTestCaseAccess().getDescriptionAssignment_3(), "rule__JexTestCase__DescriptionAssignment_3");
					put(grammarAccess.getJexTestCaseAccess().getUrlAssignment_4_1(), "rule__JexTestCase__UrlAssignment_4_1");
					put(grammarAccess.getJexTestCaseAccess().getImportSectionAssignment_5(), "rule__JexTestCase__ImportSectionAssignment_5");
					put(grammarAccess.getJexTestCaseAccess().getInstancesAssignment_6_0_1(), "rule__JexTestCase__InstancesAssignment_6_0_1");
					put(grammarAccess.getJexTestCaseAccess().getInstancesAssignment_6_0_2_1(), "rule__JexTestCase__InstancesAssignment_6_0_2_1");
					put(grammarAccess.getJexTestCaseAccess().getStateFunctionsAssignment_6_1(), "rule__JexTestCase__StateFunctionsAssignment_6_1");
					put(grammarAccess.getJexTestCaseAccess().getTestSequencesAssignment_6_2(), "rule__JexTestCase__TestSequencesAssignment_6_2");
					put(grammarAccess.getJexTestCaseAccess().getMethodsAssignment_6_3(), "rule__JexTestCase__MethodsAssignment_6_3");
					...
					put(grammarAccess.getJexTestSequenceAccess().getInstancesAssignment_4_1(), "rule__JexTestSequence__InstancesAssignment_4_1");
					put(grammarAccess.getJexTestSequenceAccess().getInstancesAssignment_4_2_1(), "rule__JexTestSequence__InstancesAssignment_4_2_1");
					put(grammarAccess.getJexTestSequenceAccess().getTransitionsAssignment_5(), "rule__JexTestSequence__TransitionsAssignment_5");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			...
			typedParser.entryRuleJexTestCase();
