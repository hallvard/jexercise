		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTestedOperationAccess().getGroup_2(), "rule__TestedOperation__Group_2__0");
					put(grammarAccess.getTestedOperationAccess().getGroup_2_1(), "rule__TestedOperation__Group_2_1__0");
					put(grammarAccess.getTestedOperationAccess().getGroup_5(), "rule__TestedOperation__Group_5__0");
					put(grammarAccess.getTestedOperationAccess().getGroup_6(), "rule__TestedOperation__Group_6__0");
					...
					put(grammarAccess.getTransitionAccess().getEffectAssignment_0_5(), "rule__Transition__EffectAssignment_0_5");
					put(grammarAccess.getTransitionAccess().getEffectAssignment_1(), "rule__Transition__EffectAssignment_1");
					...
					put(grammarAccess.getMethodAccess().getParametersAssignment_4_0(), "rule__Method__ParametersAssignment_4_0");
					put(grammarAccess.getMethodAccess().getParametersAssignment_4_1_1(), "rule__Method__ParametersAssignment_4_1_1");
					...
					put(grammarAccess.getTestedOperationAccess().getParameterTypesAssignment_2_0(), "rule__TestedOperation__ParameterTypesAssignment_2_0");
					put(grammarAccess.getTestedOperationAccess().getParameterTypesAssignment_2_1_1(), "rule__TestedOperation__ParameterTypesAssignment_2_1_1");
					put(grammarAccess.getTestedOperationAccess().getDescriptionAssignment_4(), "rule__TestedOperation__DescriptionAssignment_4");
					put(grammarAccess.getTestedOperationAccess().getPreExpressionAssignment_5_1(), "rule__TestedOperation__PreExpressionAssignment_5_1");
					put(grammarAccess.getTestedOperationAccess().getPostExpressionAssignment_6_1(), "rule__TestedOperation__PostExpressionAssignment_6_1");
					put(grammarAccess.getParameterTypeAccess().getTypeAssignment_0(), "rule__ParameterType__TypeAssignment_0");
					put(grammarAccess.getParameterTypeAccess().getVarargAssignment_1(), "rule__ParameterType__VarargAssignment_1");
