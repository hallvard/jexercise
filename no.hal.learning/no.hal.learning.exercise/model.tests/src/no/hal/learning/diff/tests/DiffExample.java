...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>diff</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DiffExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.diff"));
				PatchStringEdit root = DiffFactory.eINSTANCE.createPatchStringEdit();
