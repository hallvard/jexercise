 ...
 * @generated
 */
public class PydevAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected PydevSwitch<Adapter> modelSwitch =
		new PydevSwitch<Adapter>() {
			@Override
			public Adapter casePydevSourceEditAnswer(PydevSourceEditAnswer object) {
				return createPydevSourceEditAnswerAdapter();
			}
			@Override
			public Adapter casePydevSourceEditProposal(PydevSourceEditProposal object) {
				return createPydevSourceEditProposalAdapter();
			}
			@Override
			public Adapter casePydevSourceEditEvent(PydevSourceEditEvent object) {
				return createPydevSourceEditEventAdapter();
			}
			@Override
			public Adapter casePydevMarkerInfo(PydevMarkerInfo object) {
				return createPydevMarkerInfoAdapter();
			}
			@Override
			public Adapter casePydevLaunchAnswer(PydevLaunchAnswer object) {
				return createPydevLaunchAnswerAdapter();
			}
			@Override
			public Adapter casePydevLaunchProposal(PydevLaunchProposal object) {
				return createPydevLaunchProposalAdapter();
			}
			@Override
			public Adapter casePydevLaunchEvent(PydevLaunchEvent object) {
				return createPydevLaunchEventAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link no.hal.learning.exercise.pydev.PydevSourceEditAnswer <em>Source Edit Answer</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPydevSourceEditAnswerAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link no.hal.learning.exercise.pydev.PydevSourceEditProposal <em>Source Edit Proposal</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPydevSourceEditProposalAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link no.hal.learning.exercise.pydev.PydevSourceEditEvent <em>Source Edit Event</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPydevSourceEditEventAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link no.hal.learning.exercise.pydev.PydevMarkerInfo <em>Marker Info</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPydevMarkerInfoAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link no.hal.learning.exercise.pydev.PydevLaunchAnswer <em>Launch Answer</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPydevLaunchAnswerAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link no.hal.learning.exercise.pydev.PydevLaunchProposal <em>Launch Proposal</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPydevLaunchProposalAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link no.hal.learning.exercise.pydev.PydevLaunchEvent <em>Launch Event</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPydevLaunchEventAdapter() {
		return null;
	}
