 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.learning.exercise.pydev.impl.PydevLaunchEventImpl#getModuleName <em>Module Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PydevLaunchEventImpl extends LaunchEventImpl implements PydevLaunchEvent {
	...
	public void setModuleName(String newModuleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PydevPackage.PYDEV_LAUNCH_EVENT__MODULE_NAME, oldModuleName, moduleName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PydevPackage.PYDEV_LAUNCH_EVENT__MODULE_NAME:
