 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.learning.exercise.workspace.SourceFileEditEvent#getResourcePath <em>Resource Path</em>}</li>
...
public interface SourceFileEditEvent extends AbstractStringEditEvent {
	 ...
	 * @see no.hal.learning.exercise.workspace.WorkspacePackage#getSourceFileEditEvent_ResourcePath()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link no.hal.learning.exercise.workspace.SourceFileEditEvent#getResourcePath <em>Resource Path</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
