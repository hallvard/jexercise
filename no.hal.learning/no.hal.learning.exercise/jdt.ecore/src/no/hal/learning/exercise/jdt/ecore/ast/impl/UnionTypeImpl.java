 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.learning.exercise.jdt.ecore.ast.impl.UnionTypeImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnionTypeImpl extends TypeImpl implements UnionType {
	...
	protected EClass eStaticClass() {
		return AstPackage.Literals.UNION_TYPE;
	}
	...
	public EList<Type> getTypes() {
		if (types == null) {
			types = new EObjectContainmentEList<Type>(Type.class, this, AstPackage.UNION_TYPE__TYPES);
		}
		return types;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AstPackage.UNION_TYPE__TYPES:
