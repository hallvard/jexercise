 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.learning.exercise.jdt.ecore.ast.impl.TextElementImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextElementImpl extends ASTNodeImpl implements TextElement {
	...
	protected EClass eStaticClass() {
		return AstPackage.Literals.TEXT_ELEMENT;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AstPackage.TEXT_ELEMENT__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AstPackage.TEXT_ELEMENT__TEXT:
				return getText();
		}
