 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.learning.exercise.jdt.ecore.ast.impl.IntersectionTypeImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntersectionTypeImpl extends TypeImpl implements IntersectionType {
	...
	protected EClass eStaticClass() {
		return AstPackage.Literals.INTERSECTION_TYPE;
	}
	...
	public EList<Type> getTypes() {
		if (types == null) {
			types = new EObjectContainmentEList<Type>(Type.class, this, AstPackage.INTERSECTION_TYPE__TYPES);
		}
		return types;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AstPackage.INTERSECTION_TYPE__TYPES:
