		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RelativeStringEdit_edit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RelativeStringEdit_edit_feature", "_UI_RelativeStringEdit_type"),
				 ExercisePackage.Literals.RELATIVE_STRING_EDIT__EDIT,
				 true,
				 false,
				 true,
				 null,
