 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.learning.quiz.impl.CharStyleImpl#getItalic <em>Italic</em>}</li>
 *   <li>{@link no.hal.learning.quiz.impl.CharStyleImpl#getBold <em>Bold</em>}</li>
 *   <li>{@link no.hal.learning.quiz.impl.CharStyleImpl#getSize <em>Size</em>}</li>
 *   <li>{@link no.hal.learning.quiz.impl.CharStyleImpl#getFamily <em>Family</em>}</li>
 *   <li>{@link no.hal.learning.quiz.impl.CharStyleImpl#getForeground <em>Foreground</em>}</li>
 *   <li>{@link no.hal.learning.quiz.impl.CharStyleImpl#getBackground <em>Background</em>}</li>
 * </ul>
 *
 * @generated
 */
