 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.learning.exercise.impl.BooleanAnswerImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanAnswerImpl extends SimpleAnswerImpl<Boolean> implements BooleanAnswer {
	...
	protected EClass eStaticClass() {
		return ExercisePackage.Literals.BOOLEAN_ANSWER;
	}
	...
	public void setValue(Boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExercisePackage.BOOLEAN_ANSWER__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExercisePackage.BOOLEAN_ANSWER__VALUE:
				return getValue();
		}
