 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.learning.exercise.impl.SimpleProposalImpl#getProposal <em>Proposal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SimpleProposalImpl<A extends SimpleAnswer<?>> extends ProposalImpl<A> implements SimpleProposal<A> {
	...
	protected EClass eStaticClass() {
		return ExercisePackage.Literals.SIMPLE_PROPOSAL;
	}
	...
	public void setProposal(Object newProposal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExercisePackage.SIMPLE_PROPOSAL__PROPOSAL, oldProposal, proposal));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExercisePackage.SIMPLE_PROPOSAL__PROPOSAL:
				return getProposal();
		}
