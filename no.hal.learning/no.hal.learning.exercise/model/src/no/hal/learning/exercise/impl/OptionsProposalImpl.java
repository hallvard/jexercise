 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.learning.exercise.impl.OptionsProposalImpl#getIndices <em>Indices</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OptionsProposalImpl extends ProposalImpl<OptionsAnswer> implements OptionsProposal {
	...
	protected EClass eStaticClass() {
		return ExercisePackage.Literals.OPTIONS_PROPOSAL;
	}
	...
	public EList<Integer> getIndices() {
		if (indices == null) {
			indices = new EDataTypeUniqueEList<Integer>(Integer.class, this, ExercisePackage.OPTIONS_PROPOSAL__INDICES);
		}
		return indices;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExercisePackage.OPTIONS_PROPOSAL__INDICES:
				return getIndices();
		}
