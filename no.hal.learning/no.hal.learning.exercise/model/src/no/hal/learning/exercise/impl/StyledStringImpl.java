 ...
 * </p>
 * <ul>
 *   <li>{@link no.hal.learning.exercise.impl.StyledStringImpl#getCharStyle <em>Char Style</em>}</li>
 *   <li>{@link no.hal.learning.exercise.impl.StyledStringImpl#getEffectiveCharStyle <em>Effective Char Style</em>}</li>
 *   <li>{@link no.hal.learning.exercise.impl.StyledStringImpl#getPrefix <em>Prefix</em>}</li>
 *   <li>{@link no.hal.learning.exercise.impl.StyledStringImpl#getStyledString <em>Styled String</em>}</li>
 *   <li>{@link no.hal.learning.exercise.impl.StyledStringImpl#getSuffix <em>Suffix</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StyledStringImpl extends MinimalEObjectImpl.Container implements StyledString {
	...
	protected EClass eStaticClass() {
		return ExercisePackage.Literals.STYLED_STRING;
	}
	...
	public NotificationChain basicSetCharStyle(CharStyle newCharStyle, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExercisePackage.STYLED_STRING__CHAR_STYLE, oldCharStyle, newCharStyle);
	...
	public void setCharStyle(CharStyle newCharStyle) {
		if (newCharStyle != charStyle) {
			...
			if (charStyle != null)
				msgs = ((InternalEObject)charStyle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExercisePackage.STYLED_STRING__CHAR_STYLE, null, msgs);
			if (newCharStyle != null)
				msgs = ((InternalEObject)newCharStyle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ExercisePackage.STYLED_STRING__CHAR_STYLE, null, msgs);
			msgs = basicSetCharStyle(newCharStyle, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExercisePackage.STYLED_STRING__CHAR_STYLE, newCharStyle, newCharStyle));
	}
	...
	public CharStyle basicGetEffectiveCharStyle() {
		CharStyle effectiveCharStyle = ExerciseFactory.eINSTANCE.createCharStyle();
	...
	private void computeEffectiveCharStyle(StyledString styledString, CharStyle effectiveCharStyle) {
		...
		setFeaturesIfNonNull(effectiveCharStyle, styledString,
				ExercisePackage.eINSTANCE.getCharStyle_Italic(), ExercisePackage.eINSTANCE.getCharStyle_Bold(),
				ExercisePackage.eINSTANCE.getCharStyle_Size(), ExercisePackage.eINSTANCE.getCharStyle_Family(),
				ExercisePackage.eINSTANCE.getCharStyle_Foreground(), ExercisePackage.eINSTANCE.getCharStyle_Background()
		);
	}
	...
	public void setPrefix(String newPrefix) {
		...
		prefix = newPrefix;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExercisePackage.STYLED_STRING__PREFIX, oldPrefix, prefix));
	}
	...
	public NotificationChain basicSetStyledString(StyledString newStyledString, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExercisePackage.STYLED_STRING__STYLED_STRING, oldStyledString, newStyledString);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStyledString(StyledString newStyledString) {
		if (newStyledString != styledString) {
			...
			if (styledString != null)
				msgs = ((InternalEObject)styledString).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExercisePackage.STYLED_STRING__STYLED_STRING, null, msgs);
			if (newStyledString != null)
				msgs = ((InternalEObject)newStyledString).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ExercisePackage.STYLED_STRING__STYLED_STRING, null, msgs);
			msgs = basicSetStyledString(newStyledString, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExercisePackage.STYLED_STRING__STYLED_STRING, newStyledString, newStyledString));
	}
	...
	public void setSuffix(String newSuffix) {
		...
		suffix = newSuffix;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExercisePackage.STYLED_STRING__SUFFIX, oldSuffix, suffix));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ExercisePackage.STYLED_STRING__CHAR_STYLE:
				return basicSetCharStyle(null, msgs);
			case ExercisePackage.STYLED_STRING__STYLED_STRING:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExercisePackage.STYLED_STRING__CHAR_STYLE:
				return getCharStyle();
			case ExercisePackage.STYLED_STRING__EFFECTIVE_CHAR_STYLE:
				if (resolve) return getEffectiveCharStyle();
				return basicGetEffectiveCharStyle();
			case ExercisePackage.STYLED_STRING__PREFIX:
				return getPrefix();
			case ExercisePackage.STYLED_STRING__STYLED_STRING:
				return getStyledString();
			case ExercisePackage.STYLED_STRING__SUFFIX:
				return getSuffix();
		}
