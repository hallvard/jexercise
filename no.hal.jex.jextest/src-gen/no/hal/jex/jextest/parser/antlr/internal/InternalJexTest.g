...
(	otherlv_0='test' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getJexTestCaseAccess().getTestKeyword_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getJexTestCaseAccess().getTestedClassJvmParameterizedTypeReferenceParserRuleCall_1_0()); 
	    }
		lv_testedClass_1_0=ruleJvmParameterizedTypeReference		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getJexTestCaseAccess().getWithKeyword_2_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getJexTestCaseAccess().getTestClassNameQNameParserRuleCall_2_1_0()); 
	    }
		lv_testClassName_3_0=ruleQName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getJexTestCaseRule());
	        }
       		set(
...
(
		...
		{
			newLeafNode(lv_description_4_0, grammarAccess.getJexTestCaseAccess().getDescriptionSTRINGTerminalRuleCall_3_0()); 
		}
		{
	        if ($current==null) {
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getJexTestCaseAccess().getCommercialAtKeyword_4_0());
    }
(
(
		lv_url_6_0=RULE_STRING
		{
			newLeafNode(lv_url_6_0, grammarAccess.getJexTestCaseAccess().getUrlSTRINGTerminalRuleCall_4_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getJexTestCaseRule());
...
(
		{ 
	        newCompositeNode(grammarAccess.getJexTestCaseAccess().getImportSectionXImportSectionParserRuleCall_5_0()); 
	    }
		lv_importSection_7_0=ruleXImportSection		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getJexTestCaseRule());
	        }
       		set(
    ...
    {
    	newLeafNode(otherlv_8, grammarAccess.getJexTestCaseAccess().getInstanceKeyword_6_0_0_0());
    }

    |	otherlv_9='val' 
    {
    	newLeafNode(otherlv_9, grammarAccess.getJexTestCaseAccess().getValKeyword_6_0_0_1());
    }
)(
(
		{ 
	        newCompositeNode(grammarAccess.getJexTestCaseAccess().getInstancesInstanceParserRuleCall_6_0_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_11, grammarAccess.getJexTestCaseAccess().getCommaKeyword_6_0_2_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getJexTestCaseAccess().getInstancesInstanceParserRuleCall_6_0_2_1_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getJexTestCaseAccess().getStateFunctionsStateFunctionParserRuleCall_6_1_0()); 
	    }
		lv_stateFunctions_13_0=ruleStateFunction		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getJexTestCaseRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getJexTestCaseAccess().getTestSequencesJexTestSequenceParserRuleCall_6_2_0()); 
	    }
		lv_testSequences_14_0=ruleJexTestSequence		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getJexTestCaseRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getJexTestCaseAccess().getMethodsMethodParserRuleCall_6_3_0()); 
	    }
