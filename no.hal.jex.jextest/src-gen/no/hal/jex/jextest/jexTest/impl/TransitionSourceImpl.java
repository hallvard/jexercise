...
public class TransitionSourceImpl extends MinimalEObjectImpl.Container implements TransitionSource
{
  ...
  public void setState(State newState)
  {
    if (newState != state)
    {
      ...
      if (state != null)
        msgs = ((InternalEObject)state).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JexTestPackage.TRANSITION_SOURCE__STATE, null, msgs);
      if (newState != null)
        msgs = ((InternalEObject)newState).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JexTestPackage.TRANSITION_SOURCE__STATE, null, msgs);
      msgs = basicSetState(newState, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JexTestPackage.TRANSITION_SOURCE__STATE, newState, newState));
  }
  ...
  public State getStateRef()
  {
    if (stateRef != null && stateRef.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, JexTestPackage.TRANSITION_SOURCE__STATE_REF, oldStateRef, stateRef));
      }
    }
    return stateRef;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JexTestPackage.TRANSITION_SOURCE__STATE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case JexTestPackage.TRANSITION_SOURCE__STATE:
        return getState();
      case JexTestPackage.TRANSITION_SOURCE__STATE_REF:
