...
public class JexTestSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == JexTestPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case JexTestPackage.JEX_TEST_SEQUENCE:
				if(context == grammarAccess.getJexTestSequenceRule() ||
				   context == grammarAccess.getStateTestContextRule()) {
			...
			case JexTestPackage.OBJECT_TEST:
				if(context == grammarAccess.getObjectTestRule() ||
				   context == grammarAccess.getPropertiesTestOwnerRule()) {
			...
			case JexTestPackage.PROPERTIES_TEST:
				if(context == grammarAccess.getPropertiesTestRule()) {
			...
			case JexTestPackage.STATE_FUNCTION:
				if(context == grammarAccess.getPropertiesTestOwnerRule() ||
				   context == grammarAccess.getStateFunctionRule() ||
				   context == grammarAccess.getStateTestContextRule()) {
			...
			case JexTestPackage.TESTED_CLASS:
				if(context == grammarAccess.getTestedClassRule()) {
					sequence_TestedClass(context, (TestedClass) semanticObject); 
					return; 
				}
				else break;
			case JexTestPackage.TESTED_CONSTRUCTOR:
				if(context == grammarAccess.getTestedConstructorRule()) {
					sequence_TestedConstructor(context, (TestedConstructor) semanticObject); 
					return; 
				}
				else if(context == grammarAccess.getTestedOperationRule()) {
					sequence_TestedOperation(context, (TestedConstructor) semanticObject); 
					return; 
				}
				else break;
			case JexTestPackage.TESTED_METHOD:
				if(context == grammarAccess.getTestedMethodRule()) {
			...
			case JexTestPackage.TRANSITION_EXCEPTION_EFFECT:
				if(context == grammarAccess.getTransitionEffectRule() ||
				   context == grammarAccess.getTransitionExceptionEffectRule()) {
			...
			case JexTestPackage.TRANSITION_EXPRESSION_ACTION:
				if(context == grammarAccess.getTransitionActionRule() ||
				   context == grammarAccess.getTransitionExpressionActionRule()) {
			...
			case JexTestPackage.TRANSITION_SOURCE:
				if(context == grammarAccess.getTransitionSourceRule()) {
			...
			case JexTestPackage.TRANSITION_TARGET_EFFECT:
				if(context == grammarAccess.getTransitionEffectRule() ||
				   context == grammarAccess.getTransitionTargetEffectRule()) {
	 ...
	 *         ((instances+=Instance instances+=Instance*) | stateFunctions+=StateFunction | testSequences+=JexTestSequence | methods+=Method)*
	 *     )
	 */
	protected void sequence_JexTestCase(EObject context, JexTestCase semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_PropertiesTest(EObject context, PropertiesTest semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_StateFunction(EObject context, StateFunction semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     )
	 */
	protected void sequence_TestedClass(EObject context, TestedClass semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     {TestedConstructor}
	 */
	protected void sequence_TestedConstructor(EObject context, TestedConstructor semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_TestedMethod(EObject context, TestedMethod semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_TransitionExceptionEffect(EObject context, TransitionExceptionEffect semanticObject) {
	 ...
	 */
	protected void sequence_TransitionExpressionAction(EObject context, TransitionExpressionAction semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     input=STRING
	 */
	protected void sequence_TransitionInputAction(EObject context, TransitionInputAction semanticObject) {
		if(errorAcceptor != null) {
	 ...
	 */
	protected void sequence_TransitionSource(EObject context, TransitionSource semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     (state=State | stateRef=[State|ID])
	 */
	protected void sequence_TransitionTargetEffect(EObject context, TransitionTargetEffect semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
