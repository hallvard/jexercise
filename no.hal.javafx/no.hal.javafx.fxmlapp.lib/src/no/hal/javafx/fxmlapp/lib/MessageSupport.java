...
public abstract class MessageSupport {
	...
	protected Object callback(String... args) {
	...
	protected Object[] toValues(String[] args, Class<?>[] types) {
	...
	protected Object toValue(String arg, Class<?> valueClass) {
	...
	protected <T> T toValue(byte[] bytes, Class<T> valueClass) {
		return (T) toValue(toString(bytes), valueClass);
	}
	...
	public static void main(String[] args) {
		...
		MessageSupport messageSupport = new MessageSupport(handler, "receive1", "receive2") {
			@Override
