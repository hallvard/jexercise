...
public class InternalXemfsLexer extends Lexer {
    ...
    public final void mRULE_STRING_CONTENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // ../no.hal.emfs.xtext.runtime/src-gen/no/hal/emfs/xtext/parser/antlr/internal/InternalXemfs.g:2449:21: ( '---8<---\\n' ( options {greedy=false; } : . )* '\\n--->8---' )
            // ../no.hal.emfs.xtext.runtime/src-gen/no/hal/emfs/xtext/parser/antlr/internal/InternalXemfs.g:2449:23: '---8<---\\n' ( options {greedy=false; } : . )* '\\n--->8---'
            {
            match("---8<---\n"); 

            // ../no.hal.emfs.xtext.runtime/src-gen/no/hal/emfs/xtext/parser/antlr/internal/InternalXemfs.g:2449:36: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // ../no.hal.emfs.xtext.runtime/src-gen/no/hal/emfs/xtext/parser/antlr/internal/InternalXemfs.g:2449:64: .
            	    {
            	    matchAny(); 
    ...
    static class DFA1 extends DFA {
        ...
        public String getDescription() {
            return "()* loopback of 2449:36: ( options {greedy=false; } : . )*";
        }
