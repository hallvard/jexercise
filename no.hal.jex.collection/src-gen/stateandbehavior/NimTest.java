...
public class NimTest extends TestCase {
  ...
  private boolean checkValidation(final int pieces, final boolean legal, final Nim game) {
    ...
    boolean _isValidMove = game.isValidMove(pieces, 1);
    if (!_isValidMove) {
      _and_1 = false;
    } else {
      boolean _isValidMove_1 = game.isValidMove(pieces, 2);
      _and_1 = _isValidMove_1;
    }
    if (!_and_1) {
      _and = false;
    } else {
      boolean _isValidMove_2 = game.isValidMove(pieces, 3);
      _and = _isValidMove_2;
    }
    return (legal == _and);
  }
  ...
  private void _test__constructor_transitions0_effect_state_objectTests0_test(final Nim it) {
    ...
    int _pile = it.getPile(1);
    assertEquals("getPile(1) == 5 failed", 5, _pile);
    
    int _pile_1 = it.getPile(2);
    assertEquals("getPile(2) == 5 failed", 5, _pile_1);
    
    int _pile_2 = it.getPile(3);
    assertEquals("getPile(3) == 5 failed", 5, _pile_2);
  ...
  private void _transition_exprAction__removePieces_transitions0_actions0(final Nim it) {
    try {
      ...
      fail("removePieces(3, 1) failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__removePieces_transitions0_actions1(final Nim it) {
    try {
      ...
      fail("removePieces(2, 2) failed: " + error.getMessage());
    }
  ...
  private void _transition_exprAction__removePieces_transitions0_actions2(final Nim it) {
    try {
      ...
      fail("removePieces(1, 3) failed: " + error.getMessage());
    }
  ...
  private void _test__removePieces_transitions0_effect_state_objectTests0_test(final Nim it) {
    ...
    int _pile = it.getPile(1);
    assertEquals("getPile(1) == 2 failed after removePieces(3, 1) ,removePieces(2, 2) ,removePieces(1, 3)", 2, _pile);
    
    int _pile_1 = it.getPile(2);
    assertEquals("getPile(2) == 3 failed after removePieces(3, 1) ,removePieces(2, 2) ,removePieces(1, 3)", 3, _pile_1);
    
    int _pile_2 = it.getPile(3);
    assertEquals("getPile(3) == 4 failed after removePieces(3, 1) ,removePieces(2, 2) ,removePieces(1, 3)", 4, _pile_2);
  ...
  private void _transition_exprAction__removePieces_transitions1_actions0(final Nim it) {
    try {
      ...
      fail("removePieces(-1, 1) failed: " + error.getMessage());
    }
  ...
  private void _test__removePieces_transitions1_effect_state_objectTests0_test(final Nim it) {
    ...
    int _pile = it.getPile(1);
    assertEquals("getPile(1) == 2 failed after removePieces(-1, 1)", 2, _pile);
  ...
  private void _transition_exprAction__removePieces_transitions2_actions0(final Nim it) {
    try {
      ...
      fail("removePieces(0, 1) failed: " + error.getMessage());
    }
  ...
  private void _test__removePieces_transitions2_effect_state_objectTests0_test(final Nim it) {
    ...
    int _pile = it.getPile(1);
    assertEquals("getPile(1) == 2 failed after removePieces(0, 1)", 2, _pile);
  ...
  private void _transition_exprAction__removePieces_transitions3_actions0(final Nim it) {
    try {
      ...
      fail("removePieces(6, 1) failed: " + error.getMessage());
    }
  ...
  private void _test__removePieces_transitions3_effect_state_objectTests0_test(final Nim it) {
    ...
    int _pile = it.getPile(1);
    assertEquals("getPile(1) == 2 failed after removePieces(6, 1)", 2, _pile);
  ...
  private void _transition_exprAction__gameOver_transitions1_actions0(final Nim it) {
    try {
      ...
      fail("removePieces(5, 1) failed: " + error.getMessage());
    }
  ...
  private void _test__gameOver_transitions1_effect_state_objectTests0_test(final Nim it) {
    ...
    int _pile = it.getPile(1);
    assertEquals("getPile(1) == 0 failed after removePieces(5, 1)", 0, _pile);
    
    assertTrue("isGameOver() failed after removePieces(5, 1)", it.isGameOver());
  ...
  private void _test__isValidMove_transitions1_effect_state_objectTests0_test(final Nim it) {
    ...
    assertTrue("checkValidation(2, false, nim) failed after removePieces(5, 1)", this.checkValidation(2, false, this.nim));
