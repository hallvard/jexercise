...
public class SummingIteratorTest extends TestCase {
  ...
  private List<Integer> _init_list86() {
    return Collections.<Integer>unmodifiableList(Lists.<Integer>newArrayList(Integer.valueOf(8), Integer.valueOf(7), Integer.valueOf(6)));
  }
  
  private List<Integer> list13;
  
  private List<Integer> _init_list13() {
    return Collections.<Integer>unmodifiableList(Lists.<Integer>newArrayList(Integer.valueOf(1), Integer.valueOf(2), Integer.valueOf(3)));
  }
  ...
  private void _test__caseEmpty_transitions0_effect_state_objectTests0_test() {
    try {
      ...
      this.testIterator(Collections.<Integer>unmodifiableList(Lists.<Integer>newArrayList()), Collections.<Integer>unmodifiableList(Lists.<Integer>newArrayList()));
  ...
  private void _test__case1122_transitions0_effect_state_objectTests0_test() {
    try {
      ...
      this.testIterator(Collections.<Integer>unmodifiableList(Lists.<Integer>newArrayList(Integer.valueOf(1))), Collections.<Integer>unmodifiableList(Lists.<Integer>newArrayList(Integer.valueOf(2))), 3);
      } catch (junit.framework.AssertionFailedError error) {
