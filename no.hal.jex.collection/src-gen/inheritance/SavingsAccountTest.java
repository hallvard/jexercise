...
public class SavingsAccountTest extends TestCase {
  ...
  public void testDepositAndWithdrawIllegalStateOrInput() {
    ...
    _test__depositAndWithdrawIllegalStateOrInput_transitions1_effects0_state(savingsAccount);
    try {
    ...
    _test__depositAndWithdrawIllegalStateOrInput_transitions3_effects0_state(savingsAccount);
    try {
  ...
  public void testEndYearUpdate() {
    ...
    _test__endYearUpdate_transitions0_effects0_state(savingsAccount);
  ...
  private void _test__balanceField_transitions0_effects0_state(final SavingsAccount it) {
    _test__balanceField_transitions0_effects0_state_objectTests0_test(savingsAccount);
  ...
  private void _test__depositAndWithdraw_transitions0_effects0_state(final SavingsAccount it) {
    _test__depositAndWithdraw_transitions0_effects0_state_objectTests0_test(savingsAccount);
  ...
  private void _test__depositAndWithdrawIllegalStateOrInput_transitions1_effects0_state(final SavingsAccount it) {
    _test__depositAndWithdrawIllegalStateOrInput_transitions1_effects0_state_objectTests0_test(savingsAccount);
  ...
  private void _test__depositAndWithdrawIllegalStateOrInput_transitions3_effects0_state(final SavingsAccount it) {
    _test__depositAndWithdrawIllegalStateOrInput_transitions3_effects0_state_objectTests0_test(savingsAccount);
  ...
  private void _test__depositAndWithdrawIllegalStateOrInput_transitions5_effects0_state(final SavingsAccount it) {
    _test__depositAndWithdrawIllegalStateOrInput_transitions5_effects0_state_objectTests0_test(savingsAccount);
  ...
  private void _test__endYearUpdate_transitions0_effects0_state(final SavingsAccount it) {
    _test__endYearUpdate_transitions0_effects0_state_objectTests0_test(savingsAccount);
