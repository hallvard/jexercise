...
public class AccountTest extends TestCase {
	...
	public void testAccount() {
		...
		try {
			...
			fail("Creating Account with negative balance should throw an exception.");
		} catch (Exception e) {
			assertEquals(100.0d, account.getBalance(), epsilon);
			assertEquals(5.0d, account.getInterestRate(), epsilon);	
		...
		try {
			...
			fail("Creating Account with negative interestRate should throw an exception.");
		} catch (Exception e) {
			assertEquals(100.0d, account.getBalance(), epsilon);
			assertEquals(5.0d, account.getInterestRate(), epsilon);
			assertTrue(e instanceof IllegalArgumentException);
	...
	public void testDepositNegativeAmount() {
		try {
			account.deposit(-50);
			fail("deposit should throw exception when given negative amounts.");
		} catch (Exception e) {
