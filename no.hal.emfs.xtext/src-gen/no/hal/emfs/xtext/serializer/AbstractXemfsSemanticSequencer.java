...
public abstract class AbstractXemfsSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	/**
	 * Constraint:
	 *     (name=EmfsName? tags+=ID* (contentProvider=GitContentProvider | contentProvider=EmfsResourcesRef)? resources+=EmfsResource*)
	 */
	...
	/**
	 * Constraint:
	 *     (((host=GIT_HOST owner=ID?) | owner=ID) repo=ID path=URL_PATH?)
	 */
