...
import no.hal.jex.java.JExercise;
...
@JExercise(
		...
		description="Fraction-klassen skal representere en brøk (teller og nevner)." +
				...
				"<p>" +
				"Alle former for utregning skal bruke teller og nevner (ikke flyttallsberegninger), og resultatet skal alltid være en ny brøk." +
...
public class FractionTest extends TestCase {
	...
	@JExercise(
			...
			description="Når vi utfører en regneoperasjon med 2 brøker, får vi ofte en brøk som kan forenkles." +
					...
					"<p>" +
					"Eksempel på hvordan simplify vil fungere:" +
					"<p><code>" +
